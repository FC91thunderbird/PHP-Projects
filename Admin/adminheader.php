...
body{
	background: url('../pic/body/Winter.jpg')  no-repeat center center fixed;
}
.search
{
	margin-left: 520px;
...
<nav class="navbar navbar-amol navbar-fixed-top">
  <div class="container">
         ...
         <div class="col-lg-2">
			<div class="navbar navbar-amol">
				<ul class="nav nav-pills nav-stacked"> 
						...
						<li class="active text-center"><a href="item.php">Add Product <img src="../pic/Icon/arrow.png" height="15px"></a></li>
						...
						<li class="active text-center"><a href="seeorder.php">See Order List</a></li>
