    ...
    <div class="panel panel-primary">
				...
				<!--<?php 
					...
					<?php }?>-->
					  ...
					  <div class="col-lg-3">
							<div class="thumbnail">
									<img src="Pic/6.jpg" height="100px">
									  <div class="caption text-center">
										<h4>Samsung Android mobile</h4>
						...
						<div class="col-lg-3">
							<div class="thumbnail">
									<img src="Pic/apple.jpg" height="100px">
									  <div class="caption text-center">
										<h4>apple</h4>
					   ...
					   <div class="col-lg-3">
							<div class="thumbnail">
									<img src="Pic/windows.jpg" height="100px">
									  <div class="caption text-center">
						 ...
						 <div class="col-lg-3">
							<div class="thumbnail">
									<img src="Pic/mob1.png" height="100px">
									  <div class="caption text-center">
										<h4>Sony Mobile</h4>
